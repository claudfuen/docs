...
<Steps>
  ...
  <video
    ...
    playsInline
    className="w-full"
    src="https://storage.cloud.google.com/leap-docs/create_workflow.mp4"
  ></video>
</Frame>
</Step>
...
<Step title="Configure the Workflow">
  ...
  <Frame>
    <video
      ...
      playsInline
      className="w-full"
      src="https://storage.cloud.google.com/leap-docs/configure_workflow.mp4"
    ></video>
  </Frame>
</Step>
...
<Step title="Publish and Run">
  ...
  <video
    ...
    playsInline
    className="w-full"
    src="https://storage.cloud.google.com/leap-docs/publish.mp4"
  ></video>
</Frame>
  </Step>
</Steps>
